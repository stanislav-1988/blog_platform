...
function CreateNewArticle({ history, loadingArticle, olState, match, generatedTagsForNewPost }) {
  const { tagsInput, keyTagsNewArticle, page, detailsSelectedArticle } = olState;
